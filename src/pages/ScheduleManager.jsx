    ...
    <div className="space-y-10 h-full flex flex-col relative">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl font-bold tracking-tight" style={{ color: '#86626E' }}>Schedule</h1>
            <p className="text-sm mt-0.5" style={{ color: '#86626E' }}>Real-time treatment room and specialist availability.</p>
          </div>
          <button
                    ...
                    {filtered.map(booking => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-6 py-5">
                            <p className="text-xs font-bold text-primary">{getServiceLabel(booking)}</p>
                          </td>
                          <td className="px-6 py-5">
